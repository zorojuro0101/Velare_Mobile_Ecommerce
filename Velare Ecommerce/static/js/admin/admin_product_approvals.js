            ...
            Object.values(variantsByColor).forEach(colorGroup => {
                ...
                if (colorGroup.images && colorGroup.images.length > 0) {
                    ...
                    colorGroup.images.forEach((img, idx) => {
                        ...
                        variantsHTML += `<img src="/${img.url}" alt="${colorGroup.color_name} - Image ${idx + 1}" class="variant-thumb">`;
                        if (img.is_primary) {
                    ...
                    variantsHTML += `<img src="/${colorGroup.image_url}" alt="${colorGroup.color_name}" class="variant-thumb">`;
                    variantsHTML += '<span class="primary-badge">Primary</span>';
                    variantsHTML += '</div>';
                    variantsHTML += '</div>';
                }
            ...
            <div class="card-body">
                <div class="product-image-section">
                    ...
                    <div class="thumbnail-images" data-product-id="${product.product_id}">
                        ${defaultThumbnails.map(img => `<img src="/${img.url}" alt="Thumbnail">`).join('')}
                    </div>
                </div>
            ...
            variantGroup.addEventListener('click', function() {
                ...
                if (variantImagesData && variantImagesData[colorKey]) {
                    ...
                    if (imagesData.primary) {
                        mainImageContainer.src = `/${imagesData.primary.url}`;
                    }
