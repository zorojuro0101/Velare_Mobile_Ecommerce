-- ============================================
-- PRODUCT REVIEWS WITH SENTIMENT - NO ORDER CONSTRAINT
-- PostgreSQL/Supabase Compatible
-- ============================================
-- This version temporarily disables foreign key checks
-- Then inserts reviews without order_id constraint issues
-- ============================================
...
-- Step 3: Re-enable the foreign key constraint (optional - only if you want to keep it)
-- ALTER TABLE product_reviews ADD CONSTRAINT product_reviews_order_id_fkey 
-- FOREIGN KEY (order_id) REFERENCES orders(order_id) ON DELETE CASCADE;

-- ============================================
-- NOTE: If you want to keep the constraint, uncomment Step 3
-- Otherwise, leave it disabled for easier testing
-- ============================================
...
-- Products 141-159 (Final Products)
INSERT INTO product_reviews (product_id, buyer_id, order_id, rating, review_text, sentiment, created_at) VALUES
...
-- 4. The foreign key constraint will be dropped temporarily
-- 5. All reviews will be inserted successfully
-- 6. You can re-enable the constraint later if needed
-- ============================================
