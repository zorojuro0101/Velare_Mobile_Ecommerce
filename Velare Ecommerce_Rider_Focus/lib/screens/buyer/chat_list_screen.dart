...
class _ChatListScreenState extends State<ChatListScreen> {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Error loading conversations: $e', style: GoogleFonts.goudyBookletter1911()),
          ),
        );
      }
    }
  ...
  Widget _buildConversationCard(ChatConversation conversation) {
    ...
    final displayName = isBuyer 
        ? (conversation.shopName ?? conversation.sellerName ?? 'Seller')
      ...
      onTap: () async {
        ...
        if (userId == null) {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('Please login first', style: GoogleFonts.goudyBookletter1911()),
              ),
            );
          }
          return;
        ...
        if (buyerId == null) {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('Buyer ID not found. Please log out and log in again.', style: GoogleFonts.goudyBookletter1911()),
              ),
            );
          }
          return;
        ...
        if (sellerUserId == null) {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('Invalid seller', style: GoogleFonts.goudyBookletter1911()),
              ),
            );
          }
          return;
        ...
        try {
          ...
          if (conversation != null && mounted) {
            ...
            if (mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Failed to create conversation', style: GoogleFonts.goudyBookletter1911()),
                ),
              );
            }
          }
          ...
          if (mounted) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('Error: $e', style: GoogleFonts.goudyBookletter1911()),
              ),
            );
          }
        }
